...
const registerUser = async (req, res) => {
  ...
  //need to implement mongo transaction since a new user is comitted in db after User.create
...
const loginUser = async (req, res) => {
  ...
  if (!username && !email) {
    throw new BadRequestError({ message: "Username or email is required" });
  }
  ...
  if (!isPasswordValid) {
    throw new BadRequestError({ message: "Invalid user credentials" });
  }
